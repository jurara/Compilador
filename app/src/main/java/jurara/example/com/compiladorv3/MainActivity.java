...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.layin, new Codigo()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_tabla) {
            fragmentito= new TablaDeSimbolos();
            hayFragmento = true;
        } else if (id == R.id.nav_errores) {
            fragmentito= new Errores();
            hayFragmento = true;
        } else if (id == R.id.nav_codigo) {
            fragmentito= new Codigo();
            hayFragmento = true;
        }
